...
describe('Cosmos API tests', () => {
  ...
  it('Delegates funds to a validator', async () => {
    const balanceBefore = await getDelegationInfo(delegatingAddress, network);
    ...
    const newBalance = await getDelegationInfo(delegatingAddress, network);
  ...
  it('Collects rewards from validator', async () => {
    // Init the client
    await client.init();
  ...
  //TODO:
  // Redelegation
  // Unable to do twice redelegation
